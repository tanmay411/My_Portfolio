...
if ($amount === null || $amount == ""):
    $_SESSION['error']['debit']['status'] = true;
    $_SESSION['error']['debit']['amount'] = "cannot be null";
endif;
...
if ($_SESSION['error']['debit']['status'] === true) {
    header("Location: http://newpro.test/newPro/debit");
    exit;
}
...
VALUES (:id, 'debit', :amount, :new_balance, :remark);";
$stmt = $pdo->prepare($sql);
